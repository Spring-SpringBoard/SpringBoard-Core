...
The model API is given by the  `ObjectBridge <./_static/modules/model.object.object_bridge.ObjectBridge.html>`_ interface. More detailed `s11n <https://github.com/Spring-SpringBoard/SpringBoard-Core/tree/master/libs/s11n>`_ serialization API is also included.
