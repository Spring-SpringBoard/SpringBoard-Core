...
// These `save_texture_png` calls block the draw thread (GL read + PNG encode in
// the engine's `save_image`), freezing the editor during export. Moving the
// encode off-thread is docs/porting/todo.md #10.
