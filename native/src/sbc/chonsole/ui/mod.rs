//! Chonsole's RmlUi presentation and input view.
...
use events::{ChonsoleEvents, KeyOutcome};
use view::ChonsoleView;

/// The UI boundary used by Chonsole's coordinator.
///
/// Individual RmlUi and text-editing operations deliberately stay within this
/// module. The coordinator only deals in lifecycle, raw engine input, and an
/// optional submitted line.
#[derive(Default)]
pub(super) struct ChonsoleUi {
    view: ChonsoleView,
    events: ChonsoleEvents,
}

pub(super) enum UiKeyOutcome {
    Unhandled,
    Handled,
    Execute(String),
}
...
impl ChonsoleUi {
    ...
    pub fn update(
        ...
        self.view.process_suggestion_hovers(interface);
