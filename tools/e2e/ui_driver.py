...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="chonsole",
        choices=("chonsole", "main-panel", "lighting-panel", "units-panel", "texture-panel", "dev-console", "teams-panel", "info-panel", "settings-panel", "props-panel", "cursortip", "notifications"),
