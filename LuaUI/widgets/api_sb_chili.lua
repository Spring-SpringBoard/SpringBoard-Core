...
function widget:Initialize()
	-- Only the Chili UI uses Chili controls, so do not load the framework
	-- otherwise. Its util header is not UI: it patches `table` with
	-- ifind/merge/clear, which scen_edit and the widgets rely on.
