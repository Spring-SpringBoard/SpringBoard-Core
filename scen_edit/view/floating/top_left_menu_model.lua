...
function TopLeftMenuModel:init()
    ...
    self.openFileCallback = nil
    self.uploadLogFinishedCallback = nil
    self.uploadLogFailedCallback = nil
...
function TopLeftMenuModel:RegisterConnectorCallbacks()
    ...
    WG.Connector.Register('UploadLogFinished', self.uploadLogFinishedCallback)

    self.uploadLogFailedCallback = function(command)
    ...
    WG.Connector.Register('UploadLogFailed', self.uploadLogFailedCallback)
end

function TopLeftMenuModel:UnregisterConnectorCallbacks()
    WG.Connector.Unregister('OpenFileFinished', self.openFileCallback)
    WG.Connector.Unregister('UploadLogFinished', self.uploadLogFinishedCallback)
    WG.Connector.Unregister('UploadLogFailed', self.uploadLogFailedCallback)
end
