...
function UnitDefsPanel:FilterObject(objectDefID)
    ...
    local correctType =
        self.unitTypesID == 2 and unitDef.isBuilding or self.unitTypesID == 1 and not unitDef.isBuilding or
        self.unitTypesID == 3

    local correctTerrain =
        self.unitTerrainID == 1 and
        (not unitDef.canFly and not unitDef.floatOnWater and not unitDef.canSubmerge and unitDef.waterline == 0 and
            unitDef.minWaterDepth <= 0) or
        self.unitTerrainID == 2 and unitDef.canFly or
        self.unitTerrainID == 3 and
            (unitDef.canHover or unitDef.floatOnWater or unitDef.waterline > 0 or unitDef.minWaterDepth > 0) or
...
function FeatureDefsPanel:FilterObject(objectDefID)
    ...
    if self.featureTypeID == 3 then
        ...
        if correctType and isWreck then
            ...
            correctUnitType =
                unitTypesID == 2 and unitDef.isBuilding or unitTypesID == 1 and not unitDef.isBuilding or
                unitTypesID == 3
